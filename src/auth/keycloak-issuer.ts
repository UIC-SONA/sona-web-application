...
import {KEYCLOAK_ISSUER} from "@/constants";

export const keycloakIssuerMetadata = {
  ...
  introspection_endpoint: `${KEYCLOAK_ISSUER}/protocol/openid-connect/token/introspect`,
  ...
  check_session_iframe: `${KEYCLOAK_ISSUER}/protocol/openid-connect/login-status-iframe.html`,
  ...
  registration_endpoint: `${KEYCLOAK_ISSUER}/clients-registrations/openid-connect`,
  ...
  scopes_supported: [
    ...
    'roles', 'acr',
    'profile', 'basic',
    'offline_access', 'organization',
    'web-origins', 'email',
    'microprofile-jwt', 'address',
    'service_account'
  ],
  code_challenge_methods_supported: ['plain', 'S256'],
  tls_client_certificate_bound_access_tokens: true,
  revocation_endpoint: `${KEYCLOAK_ISSUER}/protocol/openid-connect/revoke`,
  ...
  device_authorization_endpoint: `${KEYCLOAK_ISSUER}/protocol/openid-connect/auth/device`,
  backchannel_token_delivery_modes_supported: ['poll', 'ping'],
  backchannel_authentication_endpoint: `${KEYCLOAK_ISSUER}/protocol/openid-connect/ext/ciba/auth`,
  ...
  pushed_authorization_request_endpoint: `${KEYCLOAK_ISSUER}/protocol/openid-connect/ext/par/request`,
