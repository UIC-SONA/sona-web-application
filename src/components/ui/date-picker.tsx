...
import {Button, DatePicker as DatePickerComponent, Dialog, Group, Popover,} from "react-aria-components"
import {Calendar} from "@/components/ui/calendar-rac"
import {DateInput} from "@/components/ui/datefield-rac"
import {ComponentProps} from "react";
import {DateValue} from "react-aria";

export default function DatePicker<T extends DateValue>(props: ComponentProps<typeof DatePickerComponent<T>>) {
  return (
    <DatePickerComponent
      className="space-y-2"
