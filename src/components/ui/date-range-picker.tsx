...
import {Button, DateRangePicker as DateRangePickerComponent, Dialog, Group, Popover} from "react-aria-components"
...
export default function DateRangePicker<T extends DateValue>(props: ComponentProps<typeof DateRangePickerComponent<T>>) {
  return (
